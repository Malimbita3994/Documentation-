        ...
        <header class="header">
            <div class="container">
                <nav class="nav">
                    ...
                    <a href="https://idap.juvisa.org/login" class="cta-button">Get Started</a>
                </nav>
            </div>
        </header>
        ...
        <section class="hero">
            ...
            <div class="container">
                ...
                <div class="hero-buttons animate-fade-in-up">
                    <a href="https://idap.juvisa.org/login" class="btn btn-primary">
        ...
        <section class="cta-section">
            <div class="container">
                ...
                <div class="hero-buttons">
                    <a href="https://idap.juvisa.org/register" class="btn btn-primary">
                        <i class="fas fa-user-plus"></i>
                        Create Free Account
                    </a>
                    <a href="https://idap.juvisa.org/login" class="btn btn-secondary">
            ...
            <div class="container">
                <div class="footer-content">
                    ...
                    <div class="footer-section">
                        ...
                        <p><a href="https://idap.juvisa.org/login">Login</a></p>
                        <p><a href="https://idap.juvisa.org/register">Register</a></p>
                    </div>
                    <div class="footer-section">
                        <h3>Support</h3>
