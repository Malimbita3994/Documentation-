...
// Project routes
Route::middleware('api.auth')->prefix('projects')->group(function () {
...
Route::prefix('knowledge-base')->group(function () {
    Route::get('/arxiv', [KnowledgeBaseController::class, 'arxivSearch']);
    Route::get('/health', [KnowledgeBaseController::class, 'healthCheck']);
});

// Help & Support routes (public access)
Route::prefix('help')->group(function () {
    Route::get('/sections', [HelpController::class, 'getHelpSections']);
    Route::get('/faqs', [HelpController::class, 'getFaqs']);
    Route::get('/support-info', [HelpController::class, 'getSupportInfo']);
    Route::get('/search', [HelpController::class, 'searchHelp']);
    Route::get('/system-status', [HelpController::class, 'getSystemStatus']);
    
    // Ticket submission requires authentication
    Route::middleware('api.auth')->post('/ticket', [HelpController::class, 'submitTicket']);
});